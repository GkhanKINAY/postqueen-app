...
export const UPLOAD_WIDGET_URI = 'ui://postqueen/upload';
...
<body>
  <label id="drop" class="disabled">
    ...
    <input id="file" type="file" accept="image/*,video/mp4,video/quicktime" multiple />
  </label>
  <div id="files"></div>
  <div id="error"></div>
<script>
(function () {
  ...
  request('ui/initialize', {
    appInfo: { name: 'postqueen-upload', version: '1.0.0' },
    appCapabilities: {},
