...
// app_user_id === PostQueen organization id (the app calls Purchases.logIn(orgId)).
// Product ids end with <tier>.<period> or <tier>_<period>, e.g. com.example.app.pro.yearly
