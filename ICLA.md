# PostQueen Individual Contributor License Agreement (ICLA)

Thank you for your interest in contributing to PostQueen (the "Project"). This
Individual Contributor License Agreement ("Agreement") documents the rights
granted by contributors to the Project maintainer. It applies to any
Contribution you submit to the Project as an individual (not on behalf of an
...
derivative works. The Project may license Your Contribution under the Project's
...
- If Your employer has rights to intellectual property that You create, You have
  ...
  employer has waived such rights, or the employer has executed a
  [CCLA](./CCLA.md).
...
*This is a standard contributor agreement template. If in doubt about its legal
effect, please consult your own legal counsel before contributing.*
