...
export const Testimonial: FC<{
  ...
  return (
    <div className="rounded-[16px] w-full flex flex-col gap-[16px] p-[20px] bg-newBgColorInner border border-newBorder">
      {/* Header */}
      <div className="flex gap-[12px] min-w-0">
        ...
        <div className="flex flex-col -mt-[4px] min-w-0">
          ...
          <div className="text-[11px] font-[400] text-textItemBlur">
            {description}
          </div>
        </div>
      </div>
