...
const WeekdayPulse: FC<{ counts: number[] }> = ({ counts }) => {
  ...
  return (
    <section
      ...
      className="relative overflow-visible rounded-pqMd bg-pqPop p-[16px] shadow-[inset_0_0_0_1px_var(--border)]"
    >
      <div className="mb-[14px] font-display text-[16px] font-[600] text-pqText">
      ...
      <div className="flex items-end gap-[8px] pt-[36px]">
          ...
          return (
            ...
            >
              <div
                ...
                className={clsx(
                  'h-[14px] text-[11px] font-[600] tabular-nums text-pqText',
                  active && 'invisible',
                )}
              >
              ...
              <div className="flex h-[72px] w-full items-end">
                <div
                  className={clsx(
                    'relative w-full rounded-[6px] bg-pqBrand transition-opacity',
                    !count && 'opacity-[0.22]',
                    hover != null &&
                      !active &&
                      (count ? 'opacity-[0.35]' : 'opacity-[0.14]'),
                  )}
                  style={{
                ...
                >
                  {active && (
                    <>
                      <span
                        aria-hidden="true"
                        data-pq="posting-days-mark"
                        className="absolute left-1/2 top-0 z-[1] size-[8px] -translate-x-1/2 -translate-y-1/2 rounded-full bg-pqBrand shadow-[0_0_0_2px_var(--inner)]"
                      />
                      <div
                        data-pq="chart-tooltip"
                        className="pointer-events-none absolute bottom-full left-1/2 z-[2] mb-[8px] w-max -translate-x-1/2 rounded-[8px] bg-pqInner px-[10px] py-[8px] text-start shadow-[var(--e2),inset_0_0_0_1px_var(--border)]"
                      >
                        <div
                        ...
                        <div
                          ...
                          className="text-[14px] font-bold text-pqText"
                        >
                          {postsLabel(count)}
                        </div>
                        <span
                          aria-hidden="true"
                          data-pq="chart-tooltip-caret"
                          className="absolute left-1/2 top-full h-[8px] w-[8px] -translate-x-1/2 -translate-y-1/2 rotate-45 bg-pqInner shadow-[inset_-1px_-1px_0_0_var(--border)]"
                        />
                      </div>
                    </>
                  )}
              ...
              <div
                className={clsx(
                  'text-[11px] font-[600]',
                  active ? 'text-pqText' : 'text-pqMuted',
                )}
              >
                {labels[index]}
              </div>
